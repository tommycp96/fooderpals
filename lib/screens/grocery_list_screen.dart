    ...
    return Padding(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          return Dismissible(
            // The dismissible widget includes a Key. Flutter needs this
            // to find and remove the right element in the tree.
            key: Key(item.id),
            // Sets the direction the user can swipe to dismiss.
            direction: DismissDirection.endToStart,
            // Selects the background widget to display behind the widget
            // you’re swiping. In this case, the background widget is red
            // with a white trash can Icon aligned in the center and
