...
class GroceryScreen extends StatelessWidget {
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          ...
          Navigator.push(
            ...
            // a platform-specific transition. In Android, for example,
            // it slides upwards and fades in. In iOS, it slides in from the right.
            MaterialPageRoute(
              ...
              builder: (context) => GroceryItemScreen(
                ...
                onCreate: (item) {
                  ...
                  // Once the item is added to the list, pop removes
                  // the top navigation route item, GroceryItemScreen,
  ...
  Widget buildGroceryScreen() {
    ...
    return Consumer<GroceryManager>(
      // Consumer rebuilds the widgets below itself when
      // the grocery manager items changes.
