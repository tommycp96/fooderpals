...
class _GroceryItemScreenState extends State<GroceryItemScreen> {
      ...
      appBar: AppBar(
        actions: [
          IconButton(
            ...
            onPressed: () {
              // When the user taps Save, you take all the state
              // properties and create a GroceryItem.
  ...
  Widget buildQuantityField() {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        // Add a title and the quantity labels to the quantity section
        // by creating a Row that contains two Texts.
        // You use a SizedBox to separate the Texts.
        Row(
        ...
        Slider(
          ...
          divisions: 100,
          // Set the label above the slider. Here, you want to show
          // the current value above the slider.
