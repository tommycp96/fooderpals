...
// TabManager extends ChangeNotifier. This allows the object to provide
// change notifications to its listeners.
class TabManager extends ChangeNotifier {
  ...
  // goToRecipes() is a specific function that sets selectedTab to
  // the Recipes tab, which is at index 1.
  void goToRecipes() {
    selectedTab = 1;
